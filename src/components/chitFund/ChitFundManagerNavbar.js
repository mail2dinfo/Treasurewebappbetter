...
import { FiChevronDown, FiFileText, FiGrid, FiHome, FiUsers, FiLayers, FiLogOut, FiMapPin, FiMenu, FiPackage, FiTrendingDown, FiTrendingUp, FiUserPlus } from 'react-icons/fi';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    <div className="flex items-center gap-1 sm:gap-2">
                        <Link to="/app-selection" className="flex items-center gap-1.5 px-2.5 py-2 rounded-lg text-sm font-medium text-gray-600 hover:text-red-600 hover:bg-red-50">
                        ...
                        <div className="hidden md:block text-right px-2 border-l border-gray-200">
                            ...
                            <p className="text-xs text-gray-500">Logged in as Manager</p>
                        </div>
