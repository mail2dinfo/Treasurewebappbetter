...
const MuttonStallNavbar = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-rose-800 via-rose-900 to-stone-900 sticky top-0 z-50 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          <MyTreasureBrand to={dashboardPath} subtitle="Mutton Stall POS" inverse />
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="hidden sm:block text-right px-2 border-l border-white/30">
              ...
              <p className="text-xs text-rose-100">Logged in as {roleLabel}</p>
            </div>
              ...
              {isTooltipVisible && (
                <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                  ...
                  <button
                    ...
                    className="w-full px-4 py-2 text-left text-sm text-rose-700 hover:bg-rose-50 flex items-center"
                  >
...
export default MuttonStallNavbar;
