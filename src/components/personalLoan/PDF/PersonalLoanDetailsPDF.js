...
const PersonalLoanDetailsPDF = ({ loanData = {}, companyData = {} }) => {
    const loan = loanData || {};
            ...
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.section}>
                    ...
                    <View style={styles.infoRow}>
                        ...
                        <Text style={styles.infoValue}>{subscriber.pl_cust_name || 'N/A'}</Text>
                    </View>
                    <View style={styles.infoRow}>
                        <Text style={styles.infoLabel}>Phone:</Text>
                        <Text style={styles.infoValue}>{subscriber.pl_cust_phone || 'N/A'}</Text>
                    </View>
                    <View style={styles.infoRow}>
...
export default PersonalLoanDetailsPDF;
