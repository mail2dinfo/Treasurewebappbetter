...
import PersonalLoanCompanyForm from '../../components/personalLoan/PersonalLoanCompanyForm';
import { FiPlus, FiEdit2, FiTrash2, FiPhone, FiMapPin, FiAlertCircle, FiX, FiBriefcase } from 'react-icons/fi';

const PersonalLoanCompanyManagement = () => {
    const { companies, isLoading, error, fetchCompanies, createCompany, updateCompany, deleteCompany, clearError } = usePersonalLoanContext();

    console.log('PersonalLoanCompanyManagement: companies:', companies);
    console.log('PersonalLoanCompanyManagement: isLoading:', isLoading);
    console.log('PersonalLoanCompanyManagement: error:', error);
    ...
    useEffect(() => {
        console.log('PersonalLoanCompanyManagement: Fetching companies...');
        fetchCompanies();
    }, [fetchCompanies]);
    ...
    useEffect(() => {
        if (companies.length > 0) {
            console.log('PersonalLoanCompanyManagement: Processing company images...');
            const urls = {};
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">Manage companies for Personal Loan</p>
                    </div>
                    <button
...
export default PersonalLoanCompanyManagement;
